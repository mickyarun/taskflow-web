  ...
  <div class="notification-bell">
    ...
    >
      <svg v-if="unreadCount > 0" class="bell-icon" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        <path d="M12 2a1.5 1.5 0 0 0-1.5 1.5v.7C7.36 4.86 5 7.66 5 11v4l-2 2v1h18v-1l-2-2v-4c0-3.34-2.36-6.14-5.5-6.8v-.7A1.5 1.5 0 0 0 12 2zm-2 18a2 2 0 1 0 4 0h-4z"/>
      </svg>
      <svg v-else class="bell-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round" aria-hidden="true">
        <path d="M6 11a6 6 0 1 1 12 0v3l1.7 2.2a.6.6 0 0 1-.5 1H4.8a.6.6 0 0 1-.5-1L6 14z"/>
        <path d="M10 19a2 2 0 0 0 4 0" stroke-linecap="round"/>
      </svg>
      <span v-if="unreadCount > 0" class="badge" :aria-label="`${unreadCount} unread`">
